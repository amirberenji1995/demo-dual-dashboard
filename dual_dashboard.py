...
DE_AE = AE()
FE_AE = AE()
DE_AE.load_state_dict(torch.load(importing_path + 'DE_AE_state_dict.pt', map_location=torch.device('cpu')))
FE_AE.load_state_dict(torch.load(importing_path + 'FE_AE_state_dict.pt', map_location=torch.device('cpu')))
